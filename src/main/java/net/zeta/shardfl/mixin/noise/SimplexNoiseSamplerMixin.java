...
public class SimplexNoiseSamplerMixin {
    ...
    public SimplexNoiseSamplerMixin(WorldGenRandom random) {
    ...
    public double sample(double x, double y) {
        ...
        double e = (float)(i + j) * UNSKEW_FACTOR_2D;
        double f = (float)i - e;
        double g = (float)j - e;
        double h = x - f;
        double k = y - g;
        ...
        double p = h - (float)n + UNSKEW_FACTOR_2D;
        double q = k - (float)o + UNSKEW_FACTOR_2D;
    ...
    public double sample(double x, double y, double z) {
        ...
        double g = (float)(i + j + k) * 0.16666666666666666D;
        double h = (float)i - g;
        double l = (float)j - g;
        double m = (float)k - g;
        double n = x - h;
        ...
        double bd = n - (float)w + 0.16666666666666666D;
        double be = o - (float)aa + 0.16666666666666666D;
        double bf = p - (float)ab + 0.16666666666666666D;
        double bg = n - (float)ac + 0.3333333333333333D;
        double bh = o - (float)ad + 0.3333333333333333D;
        double bi = p - (float)bc + 0.3333333333333333D;
